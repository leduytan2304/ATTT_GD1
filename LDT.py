...
def login_user_privilege(root, username, password, privilege, object, user,checkOption):   
    try:
        dsn = {
                "host": "localhost",
                "port": "1521",
...
def print_data():
    if(privilege_entry.get() =="" or object_entry.get() =="" or username_entry.get() ==""):
        ...
        print(check.get())
        login_user_privilege(root,'sys','tan123',privilege_entry.get(), object_entry.get(), username_entry.get(),check.get()) 
