...
create or replace view  view_NV_NhanVien as 
    ...
    CAST (decrypt_LUONG(n.LUONG) AS nvarchar2 (255)) as LUONG, 
    CAST (decrypt_PHUCAP(n.PHUCAP) AS nvarchar2 (255)) as PHUCAP, n.VAITRO, n.MANQL
    from nhanvien n;
...
Grant SELECT ON view_NhanVien TO NhanVien;
Grant SELECT ON view_PhanCong TO NhanVien;
